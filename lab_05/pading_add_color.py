...
def detect_red_coke_can(image, templates, stride=4, padding=0):
    ...
    # แปลงภาพเป็น HSV และสร้าง mask สำหรับสีแดง
    ...
    # กรองภาพต้นฉบับด้วย mask ที่ได้จากการตรวจจับสีแดง
    ...
    for template in templates:
        ...
        # วนลูปผ่านทุก window ในภาพที่ผ่านการกรองสีแดง
        for x, y, window in sliding_window(red_regions, (template_h, template_w), stride, padding):
    ...
    try:
        while True:
            ...
            if frame is not None:
                ...
                result_image = detect_red_coke_can(frame, templates, stride=10, padding=10)
