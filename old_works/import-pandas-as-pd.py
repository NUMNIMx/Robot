...
if __name__ == '__main__':
    ...
    goal_x = 0
    goal_y = 0
    ep_chassis.move(x=ref_x, y=ref_y, z=0, xy_speed=0.80).wait_for_completed()
    ...
    while True:
        ...
        if round(float(fm_x),1) >= 1:
            ...
            if float(fm_x) >= 1:
                ...
                ep_chassis.move(x=-1, y=0, z=0, xy_speed=0.80).wait_for_completed()
                ep_chassis.drive_speed(x=speed_x, y=speed_y, z=0, timeout=5)
